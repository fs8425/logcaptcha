...
public enum XMaterial {
    ...
    /*
     * Opcode count of 14851 triggered aggressive code reduction.  Override with --aggressivesizethreshold.
     */
    static {
    ...
    public ItemStack parseItem() {
        ...
        return new ItemStack(mat, 1, (short)((byte)this.data));
    }

    public static boolean isNewVersion() {
        Material mat = Material.getMaterial((String)"RED_WOOL");
        return mat != null;
    }
    ...
    public static XMaterial requestXMaterial(String name, byte data) {
        ...
        int n = xMaterialArray.length;
        int n2 = 0;
        while (n2 < n) {
            XMaterial mat = xMaterialArray[n2];
            String[] stringArray = mat.m;
            int n3 = mat.m.length;
            int n4 = 0;
            while (n4 < n3) {
    ...
    public static XMaterial fromString(String key) {
        ...
        try {
            ...
            xmat = split.length == 1 ? XMaterial.requestXMaterial(key, (byte)0) : XMaterial.requestXMaterial(split[0], (byte)Integer.parseInt(split[1]));
            return xmat;
        }
    }
    ...
    public Material parseMaterial() {
        ...
        return Material.matchMaterial((String)this.m[0]);
    }
}
